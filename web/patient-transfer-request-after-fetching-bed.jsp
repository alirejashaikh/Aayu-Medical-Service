  ...
  <body>
    ...
    <% 
        try{
            ...
            PreparedStatement filled_bed_list_with_ward = con.prepareStatement(QueryInterface.filled_bed_list_with_ward);
            filled_bed_list_with_ward.setString(1, ward_no);

            ResultSet rs=filled_bed_list_with_ward.executeQuery();
      ...
      <div class="container">
        <div class="row blood-request-form justify-content-center ptr">
          <div class="col-sm-9 col-md-9 col-lg-9 blood-frm">
            <form
              name="FORM"
              action="Patient_Transfer_Request_Fetch_Status_Servlet"
              method="POST"
            >
