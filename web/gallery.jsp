    ...
    <section class="gallery">
      <div class="container-fluid">
        <div class="row justify-content-center text-center">
          <h3 class="add-doctor">GALLERY</h3>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-6">
            ...
            <div class="row mt-3">
              <img
                src="./images/gallery-3-colour.jpg"
                alt=""
                class="img-fluid"
              />
            </div>
        ...
        <div class="row mt-5">
          <div class="col-sm-4 col-md-4 col-lg-4">
            <img
              src="./images/gallery-4-colour.jpg"
              alt=""
          ...
          <div class="col-sm-4 col-md-4 col-lg-4">
            <div class="row">
              <img
                src="./images/gallery-6-color.jpg"
                alt=""
                class="img-fluid"
              />
            </div>
            <div class="row mt-5">
              <img
                src="./images/gallery-7-color.jpg"
                alt=""
                class="img-fluid"
              />
            </div>
        ...
        <div class="row mt-5">
          ...
          <div class="col-sm-4 col-md-4 col-lg-4">
            <img src="./images/gallery-10-color.jpg" alt="" class="img-fluid" />
          </div>
