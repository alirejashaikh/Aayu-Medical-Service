      ...
      <div class="container">
        <div class="row blood-request-form justify-content-center ptr">
          <div class="col-sm-9 col-md-9 col-lg-9 blood-frm">
            <form
              name="FORM"
              action="Patient_Transfer_Request_Fetch_Bed_Servlet"
              method="POST"
            >
                <% 
                    try{
                        ...
                        PreparedStatement fetch_ward_where_patient_available_by_doctor_username = con.prepareStatement(QueryInterface.fetch_ward_where_patient_available_by_doctor_username);
                        fetch_ward_where_patient_available_by_doctor_username.setString(1, username);

                        ResultSet rs=fetch_ward_where_patient_available_by_doctor_username.executeQuery();
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <select name="bed_no" class="form-control">
                    ...
                    <option value="none" disabled><---Select Ward First----></option>
                </select>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row text-center">
              <div class="col-sm-12">
                <button type="button" class="btn btn-primary bd-btn">
                  Submit
                </button>
              </div>
            </div>
