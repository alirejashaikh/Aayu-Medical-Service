    ...
    <section class="doctor-add">
      <div class="container-fluid">
        <div class="row justify-content-center text-center">
          <h3 class="add-doctor">ANNOUNCEMENT</h3>
        </div>
      </div>
    </section>
    <section class="notice-publish-area">
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-6">
            <img
              src="./images/add-announcement-icon.jpg"
              alt="Add-ANNOUNCEMENT"
              class="img-fluid"
            />
          </div>
            <form name="form"  action="Publish_Announcement_Servlet" method="post">
                <div class="col-sm-6 col-md-6 col-lg-6 notice-container">
                    <div class="row justify-content-center text-center">
                        <input
                          type="text"
                          name="announcement"
                          class="notice-publish-text"
                          placeholder="Write your text is here"
                        />
                    </div>
                    <div class="row justify-content-center text-center">
                          <button type="submit" class="notice-btn">PUBLISH</button>
                        </div
                    </div>
                </div>
            </form>
