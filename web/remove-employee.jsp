    ...
    <section class="doctor-add">
      <div class="container-fluid">
        <div class="row justify-content-center text-center">
          <h3 class="add-doctor">REMOVE DOCTOR</h3>
        </div>
          
      </div>
    </section>
    <section class="remove-doc-part">
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-6">
            <img
              src="./images/remove-doc.png"
              alt="remove-doctor"
              class="img-fluid"
            />
          </div>
            ...
            <% 
                    try{
                        ...
                        PreparedStatement Fetch_Doctor_Employee_ID= con.prepareStatement(QueryInterface.Fetch_Doctor_Employee_ID);

                        ResultSet rs=Fetch_Doctor_Employee_ID.executeQuery();
                
            %>
            
          <div class="col-sm-6 col-md-6 col-lg-6">
            <form name="form"  action="RemoveDoctorServlet" method="post">
              <div
                class="row justify-content-center text-center remove-text-container"
              >
                <label for="remove-emp" class="remove-emp">Employee ID</label>
<!--                <input type="text" name="doctor_employee_id" class="remove-emp-txt-plc" />-->
                    <select name="doctor_employee_id" class="Blood-Group">
                        <%  while(rs.next()){ %>
    ...
    <section class="doctor-add">
      <div class="container-fluid">
        <div class="row justify-content-center text-center">
          <h3 class="add-doctor">REMOVE NURSE</h3>
        </div>
      </div>
    </section>
    <section class="remove-doc-part">
          ...
          <div class="col-sm-6 col-md-6 col-lg-6">
            ...
            <% 
                    try{
                        ...
                        PreparedStatement Fetch_Nurse_Employee_ID= con.prepareStatement(QueryInterface.Fetch_Nurse_Employee_ID);

                        ResultSet rs=Fetch_Nurse_Employee_ID.executeQuery();
                
            %>
            
          <div class="col-sm-6 col-md-6 col-lg-6">
            <form name="form"  action="RemoveNurseServlet" method="post">
              <div
                class="row justify-content-center text-center remove-text-container"
              >
                <label for="remove-emp" class="remove-emp">Employee ID</label>
<!--                <input type="text" name="nurse_employee_id" class="remove-emp-txt-plc" />-->

                    <select name="nurse_employee_id" class="Blood-Group">
                        <%  while(rs.next()){ %>
                        <option value="<%=rs.getString(1)%>"><%=rs.getString(1)%></option>
                    <%}%>
                    </select>
