...
<!--                    &nbsp;&nbsp;
    ...
    <% 
        try{
            ...
            PreparedStatement doctor_details_with_username= con.prepareStatement(QueryInterface.doctor_details_with_username);
            doctor_details_with_username.setString(1, username1);
            
            ResultSet rs=doctor_details_with_username.executeQuery();
            if(rs.next())
            {
    ...
    <%
                ...
                current_hospital_name_with_id.setString(1, rs.getString("hospital_id"));
                ...
                if(rs1.next())
                {
                    ...
                    {
    %>
    <section class="doctor-details-area doc-trns text-center">
      <div class="container">
        <div class="row">
            ...
            <div class="row doctor-view-sec">
              ...
              <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="view-item-doctor">
                    <span>
                        <%
                            out.println(rs.getString("doctor_name").toUpperCase());
                        %>
                    </span>
                </div>
              </div>
    ...
    <div class="container">
      <form action="DoctorTransferOrderServlet" method="post">
        <div class="form-group row">
            <input hidden name="username" value="<%=username1%>">
            <input hidden name="last_denied_reason" value="<%=rs.getString("last_denied_reason")%>">
