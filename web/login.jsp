<%
    String username= (String)session.getAttribute("Session_user_login");
if(username!=null){
%>
      ...
      <div class="row m-0">
        <div class="col-sm-6 col-md-6 col-lg-6">
          <img
            ...
            alt=""
            class="img-fluid login-form-img"
          />
        </div>
        <div class="col-sm-6 col-md-6 col-lg-6 login-form-textplace">
          ...
          <form class="box" action="<%=request.getContextPath()%>/login" method="post">
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                  <div class="row justify-content-center text-center register_here">
                    <h3 class="ahaa">
                      Not yet regisered?
                      <span class="log"><a href="user-register.jsp">Register Here</a></span>
                    </h3>
                  </div>
                </div>
              </div>
