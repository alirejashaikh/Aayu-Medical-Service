...
<!--                    &nbsp;&nbsp;
    ...
    <section class="patient-status">
      <div class="container">
        <div class="row mt-5">
          <div class="col-sm-6 col-md-6 col-lg-6">
            <img
              ...
              alt="Patient-status-update"
              class="img-fluid"
            />
          </div>
          <div class="col-sm-6 col-md-6 col-lg-6 align-items-center">
            <h2 class="nurse-patient-status-text">PATIENT STATUS</h2>
            <a href="nurse-patient-status-update.jsp">
        ...
        <div class="row mt-5">
          <div class="col-sm-6 col-md-6 col-lg-6">
            <h2 class="nurse-blood-request-text">BLOOD REQUEST</h2>
            <a href="blood-list.jsp">
        ...
        <div class="row mt-5">
          <div class="col-sm-6 col-md-6 col-lg-6">
            <img
              src="./images/nurse-3.png"
              alt="Patient-status-update"
              class="img-fluid"
            />
          </div>
          <div class="col-sm-6 col-md-6 col-lg-6 align-items-center">
            <h2 class="nurse-patient-status-text">PATIENT DETAILS</h2>
        ...
        <div class="row mt-5 justify-content-center text-center">
          ...
          >
            <h2 class="patient-status-heading">
              <a href="nurse-applying-transfer-request.jsp" class="href">TRANSFER REQUEST</a>
            </h2>
          </div>
        ...
        <div class="row mt-5 justify-content-center text-center">
          ...
          >
            <h2 class="patient-status-heading">
              <a href="nurse-transfer-order.jsp" class="href">TRANSFER ORDER</a>
            </h2>
          </div>
        </div>
      </div>
