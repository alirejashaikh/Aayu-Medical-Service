    ...
    <section class="doctor-add">
      <div class="container-fluid">
        <div class="row justify-content-center text-center">
          <h3 class="add-doctor">VIEW PATIENT</h3>
        </div>
      </div>
    </section>
    <!-- heading area end -->
    <!-- View patient area -->
    <section class="view-patient-area">
        <form name="FORM" action="View_Patient_Servlet" method="POST">
            <% 
                try{
                    Connection con=DbConnectionImpl.getConnection();
                    
                    PreparedStatement fetch_hospital_list= con.prepareStatement(QueryInterface.fetch_hospital_list);
                    PreparedStatement fetch_department_list = con.prepareStatement(QueryInterface.fetch_department_list);

                    ResultSet rs = fetch_hospital_list.executeQuery();
                    ResultSet rs1=fetch_department_list.executeQuery();
                    ...
                    <div class="row blood-request-form justify-content-center">
                        <div class="col-sm-9 col-md-9 col-lg-9 blood-frm">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select name="hospital_id" class="form-control">
                                            ...
                                            <%  while(rs.next()){ %>
                                                <option value="<%=rs.getString("Hospital_ID")%>"><%=rs.getString("Hospital_ID")%> : <%=rs.getString("Hospital_Name")%></option>
                                            <%}%>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8"> 
                                    <select name="department_id" class="form-control">
                                        ...
                                        <%  while(rs1.next()){ %>
                                            <option value="<%=rs1.getString("department_id")%>"><%=rs1.getString("department_name")%></option>
                                        <%}%>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row text-center">
                                <div class="col-sm-12">
<!--                                    <a href="patient-details-view.jsp">-->
