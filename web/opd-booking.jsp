    ...
    <div class="login-form">
      <div class="row m-0 align-items-center">
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 login-form-textplace">
          ...
          <form class="box" method="post" name="form"  action="opd_booking_fetch_doctor_servlet">
            <% 
                try{
                    Connection con=DbConnectionImpl.getConnection(); 

                    PreparedStatement fetch_hospital_id= con.prepareStatement(QueryInterface.fetch_hospital_id);
                    
                    PreparedStatement fetch_department = con.prepareStatement(QueryInterface.fetch_department);
            ...
            <div class="form-group row">
              ...
              >
              <div class="col-sm-10">
                <select name="hospital_id" class="form-control form-textplace">
