<%--<%@page import="com.sun.org.apache.xml.internal.serialize.LineSeparator.Web"%>--%>
...
<section class="doctor-add">
  <div class="container-fluid">
    <div class="row justify-content-center text-center">
      <h3 class="add-doctor">PATIENT VIEW DETAILS</h3>
    </div>
  </div>
</section>
        ...
        <div class="row justify-content-center text-center">
            <%
                try{
                        ...
                        String hospital_id=(String)request.getAttribute("hospital_id");
                        String department_id=(String)request.getAttribute("department_id");
                
                        System.out.println("\nhospital_id : "+hospital_id+"\ndepartment_id : "+department_id);
                
                        PreparedStatement fetch_patient_list_by_hospital= con.prepareStatement(QueryInterface.fetch_patient_list_by_hospital);
                        
                        fetch_patient_list_by_hospital.setString(1, department_id);
                        fetch_patient_list_by_hospital.setString(2, hospital_id);
                        fetch_patient_list_by_hospital.setString(3, department_id);
                        fetch_patient_list_by_hospital.setString(4, hospital_id);
                        
                        System.out.println(fetch_patient_list_by_hospital);
                        ResultSet rs = fetch_patient_list_by_hospital.executeQuery();
            %>
            <table class="table p-table">
                <thead class="tbl-head">
                    <tr class="tbl-head">
                        ...
                        <th scope="col" class="tbl-head">Doc Name</th>
                    </tr>
                </thead>
...
<!--                            <input type="text" class="prescription-text-add" />-->
                        ...
                        <td class="tbl-head">
                            ...
                            <span>
                                <%
                                    ...
                                    fname=fname.concat(" ").concat(mname).concat(" ").concat(lname);
                                    out.println(fname);
                                %>
                            </span>
                        </td>
                        <td class="tbl-head">
                            ...
                            <span>
                                <%
                                    out.println(rs.getString("ward_no"));
                                %>
                            </span>
                        </td>
                        <td class="tbl-head">
                        ...
                        <td class="tbl-head">
                            ...
                            <span>
                                <%
                                    out.println(rs.getString("doctor_name_1"));
                                %>
                                <br/>
                                <%    
                                    out.println(rs.getString("doctor_name_2"));
                                %>
                            </span>
                        </td>
                    </tr>
