      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 col-md-6 col-lg-6 justify-content-center">
            <form name="form" action="DoctorTransferReqServlet" method="post">
                <% 
                    try{
                        Connection con=DbConnectionImpl.getConnection();
                        String username=(String)session.getAttribute("username"); 
                        
                        PreparedStatement pst= con.prepareStatement(QueryInterface.fetch_hospital_list_except_current_hospital);
