...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-sm-5 col-md-6 col-lg-5">
            <img
              src="./images/baby_doc.png"
              alt="Baby image"
              class="img-fluid"
            />
          </div>
          <div class="col-sm-5 col-md-6 col-lg-5 wwd-hd">
            <h1 class="what-we-do-heading">WHAT WE DO?</h1>
            <h4 class="what-we-do-text">
              Our goal is to provide better treatment, especially for the middle
              class and lower-middle-class people who cannot afford to get
              treatment in a private hospital that's why we are making an
              opportunity for them that they can easily get hassle-free
    ...
    <section class="about-us-flex">
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-sm-3 col-md-3 col-lg-3 about-us-flexbox">
            <figure class="auf-img">
              <img src="./images/leadership.jpg" alt="" class="src" />
            </figure>
          </div>
          <div class="col-sm-3 col-md-3 col-lg-3 about-us-flexbox">
            <figure class="auf-img">
              <img src="./images/our_presence.jpg" alt="" class="src" />
            </figure>
          </div>
          <div class="col-sm-3 col-md-3 col-lg-3 about-us-flexbox">
            <figure class="auf-img">
              <img src="./images/csr.jpg" alt="" class="src" />
            </figure>
          </div>
        </div>
      </div>
    ...
    <section class="service-provide">
      <div class="container-fluid">
        <div class="row">
          <h2 class="service-heading">SERVICES WE PROVIDE</h2>
        </div>
        <div class="row">
          <div class="col-sm-8 sol-md-6 col-lg-8">
            <div class="row">
              <div class="col-sm-2 d-flex">
                <i class="fa fa-hand-o-right point" aria-hidden="true"></i>
              </div>
              <div class="col-sm-10">
                <h3 class="service-list">
                  Users can easily check their report, patient status via online
                </h3>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-sm-10">
                <h3 class="service-list">
                  If any people face some trouble they can directly apply for an
                  emergency bed through this site and they can select their
                  preferable hospital.
                </h3>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-sm-10">
                <h3 class="service-list">
                  After the doctor check-up patients can download their
                  prescription whenever they needed.
                </h3>
              </div>
            </div>
          </div>
          <div class="col-sm-4 sol-md-6 col-lg-4">
            <img
              src="./images/service_we_provide.png"
              alt="Service provided Photo"
              class="img-fluid"
            />
          </div>
        </div>
