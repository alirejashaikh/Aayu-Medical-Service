    ...
    <section class="doctor-add">
      <div class="container-fluid">
        <div class="row justify-content-center text-center">
          <h3 class="add-doctor">DOCTOR LOGIN</h3>
        </div>
      </div>
    </section>
    ...
    <section class="patient-status">
      <div class="container-fluid">
        <div class="row mt-5 justify-content-center text-center">
          ...
          >
            <h2 class="patient-status-heading">
              <a href="doctors-prescription-generate.jsp" class="href">PRESCRIPTION</a>
            </h2>
          </div>
        </div>
        <div class="row mt-5 justify-content-center text-center">
          ...
          >
            <h2 class="patient-status-heading">
              <a href="doctor-applying-transfer-request.jsp" class="href">TRANSFER REQUEST</a>
            </h2>
          </div>
          <div class="col-sm-6 col-md-6 col-lg-6 mt-2">
            <img
              src="./images/transfer-request.png"
        ...
        <div class="row mt-5 justify-content-center text-center">
          ...
          >
            <h2 class="patient-status-heading">
              <a href="doctor-transfer-order.jsp" class="href">TRANSFER ORDER</a>
            </h2>
          </div>
        </div>
        <div class="row mt-5 justify-content-center text-center">
          ...
          >
            <h2 class="patient-status-heading">
              <a href="patient-transfer-request.jsp" class="href">PATIENT TRANSFER REQUEST</a>
            </h2>
          </div>
          <div class="col-sm-6 col-md-6 col-lg-6 mt-2">
            <img
              src="./images/patient-transfer.png"
              alt="patient-status image"
              class="img-fluid"
            />
          </div>
        ...
        <div class="row mt-5 justify-content-center text-center">
          ...
          >
            <h2 class="patient-status-heading">
              <a href="#" class="href">VIEW REPORT</a>
            </h2>
          </div>
        </div>
      </div>
