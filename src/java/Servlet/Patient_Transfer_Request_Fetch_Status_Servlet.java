...
@WebServlet("/patient-transfer-request-after-fetching-bed")
public class Patient_Transfer_Request_Fetch_Status_Servlet extends HttpServlet {
    ...
    throws ServletException, IOException 
    {
       ...
       if(insertValidate.equals("SUCCESS"))
       {
           ...
           //request.setAttribute("bed_no",bed_no);
           session.setAttribute("ward_no",ward_no);
           session.setAttribute("bed_no",bed_no);
           RequestDispatcher rd = request.getRequestDispatcher("patient-transfer-request-after-submitting-bed.jsp");
